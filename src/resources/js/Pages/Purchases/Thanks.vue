        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-10 mx-auto flex flex-wrap">
                <div class="flex flex-wrap w-full">
                    <div class="lg:w-2/5 md:w-full md:pr-10 md:py-6 mb-10">
                    ...
                    <div class="lg:w-2/5 md:w-full md:pr-10 md:py-6 mb-10">
                        ...
                        <div class="flex relative pb-12 mb-3">
                        ...
                        <div class="flex relative pb-12 mb-3">
                            ...
                            <div class="flex-grow ml-3">
                                ...
                                <p class="leading-relaxed text-gray-400">商品を受け取りましたら、状態の確認をお願いします。問題がなければ、「受け取り完了」処理をおこなってください。</p>
                            </div>
                        </div>
                    ...
                    <div class="lg:w-2/5 md:w-full mb-10">
