                ...
                <div class="flex flex-wrap -m-4">
                    <div class="p-4 md:w-1/3" v-for="(item, index) in items" :key="item.id">
                        <div class="h-full rounded-lg overflow-hidden hover:shadow-md hover:shadow-gray-200">
                            <img class="md:h-72 w-full object-cover object-center rounded-lg" :src="'/storage/images/items/' + item.item_images[0].image_path" alt="item images">
                            <div class="p-6">
                                ...
                                <div class="flex items-center flex-wrap ">
                                    <a class="text-indigo-400 inline-flex items-center md:mb-2 lg:mb-0 cursor-pointer">詳細
